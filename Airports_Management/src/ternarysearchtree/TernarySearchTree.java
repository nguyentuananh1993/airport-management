...
public class TernarySearchTree {
	...
	*   @return LinkedList<String> An implementation of a LinkedList that is java 1.1 compatible.
	*/
	public LinkedList<String> matchPrefix(String prefix) {
	...
	*   @return LinkedList<String> An implementation of a LinkedList that is java 1.1 compatible.
	*/
	public LinkedList<String> matchPrefix(String prefix, int numReturnValues) {
		sortKeysNumReturnValues = checkNumberOfReturnValues(numReturnValues);
		sortKeysResult = new LinkedList<String>();
	...
	*/
	...
	private LinkedList<String> sortKeysResult;		// convenience variable for matchPrefix and sortKeys methods
	...
	*   @return LinkedList<String> An implementation of a LinkedList that is java 1.1 compatible.
	*/
	protected LinkedList<String> sortKeys(TSTNode startNode, int numReturnValues) {
		sortKeysNumReturnValues = checkNumberOfReturnValues(numReturnValues);
		sortKeysResult = new LinkedList<String>();
	...
	*/
	...
	private LinkedList<String> matchAlmostResult;		// convenience variable for matchAlmost
	...
	*   @return LinkedList<String> An implementation of a LinkedList that is java 1.1 compatible.
	*/
	public LinkedList<String> matchAlmost(String key) {
	...
	*   @return LinkedList<String> An implementation of a LinkedList that is java 1.1 compatible.
	*/
	protected LinkedList<String> matchAlmost(String key, int numReturnValues) {
		matchAlmostListAction = true;
		matchAlmostNumReturnValues = checkNumberOfReturnValues(numReturnValues);
		matchAlmostResult = new LinkedList<String>();
		matchAlmostKey = key;
